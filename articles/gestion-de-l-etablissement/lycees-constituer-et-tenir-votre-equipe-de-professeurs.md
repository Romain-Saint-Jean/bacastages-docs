...
- Le nom, le prénom et l'adresse e-mail de chaque professeur

---

## Une fiche n'est pas un compte

C'est la distinction qui commande tout le reste.

| | La **fiche** professeur | Le **compte** utilisateur |
|---|---|---|
...
Vous arrivez sur **« Mes professeur(e)s »**.
...
*« Un lien personnel va être envoyé, avec un e-mail de bienvenue expliquant Bacastages. Il lui ouvrira ses mini-stages de l'année scolaire en cours, sans mot de passe. »*
...
## Savoir où en est chaque personne
...
> **« Archivés » est exclu de « Tous »** : c'est le seul filtre qui montre les fiches retirées de l'équipe.

---

## Retirer quelqu'un de l'équipe

## 6. Ouvrir sa fiche, puis « Retirer de l'équipe »

## 7. Lire ce que Bacastages va faire
...
Le bouton s'appelle **« Retirer de l'équipe »**.

> Si la personne est second encadrant sur des offres à venir, l'écran vous le signale : elle en sera retirée. Et si elle avait un lien d'accès, il est révoqué.
