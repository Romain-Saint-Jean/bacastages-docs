...
Régler la façon dont Bacastages se comporte pour votre établissement : préinscriptions, présences, comptes rendus.
...
## 2. Ouvrir la carte « Paramètres généraux »

Les réglages s'affichent, rangés en **trois sections**.
...
## Les réglages qui ne sont pas ici

| Ce que vous cherchez | Où c'est |
|---|---|
| Publication automatique des annonces | **N'existe pas.** Une offre se publie d'un clic, offre par offre |
| Mode de signature, signataire, griffe, modèles de convention | Carte **« Convention »** |
| Validation automatique des conventions déposées | Carte **« Convention »**, étape « Conventions sur papier » |
| Texte des e-mails de rappel | Carte **« Email de rappel »** |
| Coordonnées, proviseur, signataire | Carte **« Informations de l'établissement »** |
| Description publique, logo, photos | Carte **« Présentation de l'établissement »** |
