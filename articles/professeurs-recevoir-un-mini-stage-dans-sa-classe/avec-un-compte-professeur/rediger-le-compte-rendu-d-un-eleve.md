...
- Un mini-stage terminé, ou en cours
- Un compte professeur, **ou** simplement le lien d'accès reçu par e-mail
...
## 2. Déplier la session concernée

## 3. Ouvrir le dossier de l'élève

## 4. Cliquer sur « Rédiger le compte rendu »
...
Une **carte de progression** en tête vous dit ce qui reste à remplir.

## 5. Donner votre appréciation générale
...
Les commentaires des autres encadrants s'affichent sous le vôtre, dans une section **« Commentaires des autres professeurs »**. Chacun garde le sien : vous n'écrasez que le vôtre.

---

## Vous y êtes

Le compte rendu est enregistré. La famille et l'établissement d'origine de l'élève y ont accès depuis leur rubrique **« Comptes-rendus »**.
