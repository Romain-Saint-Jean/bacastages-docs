...
- L'image de la **griffe** du signataire, et celle du **logo** de l'établissement
- Les deux au format **PNG ou JPEG**, **5 Mo au maximum**

> **Rien de tout cela n'est obligatoire.** Sans griffe, vos conventions papier sortent normalement : elles portent seulement un emplacement de signature à remplir à la main. Sans logo, le logo de Bacastages est utilisé par défaut.
...
L'assistant Convention s'ouvre.

## 3. Aller à l'étape « Conventions sur papier »
...
Dans la section **« Griffe du signataire »**, glissez votre fichier sur la carte **« Image de la griffe »**, ou parcourez vos fichiers.

> **Un PNG à fond transparent donne le meilleur rendu** : sur un fond blanc, l'image découpe un rectangle visible autour de la signature.

## 5. Vérifier l'aperçu

L'image apparaît sur la carte dès qu'elle est enregistrée.

---

## Activer la pré-signature
...
## 7. Aller à l'étape « Logo »

Son titre est **« Logo des conventions »**.

## 8. Déposer l'image

Glissez votre fichier sur la carte **« Logo de la convention »**.
...
## Sur un modèle personnalisé, il reste une étape
...
Les conventions générées à partir de maintenant portent votre logo, et votre griffe si vous avez activé la pré-signature.

> **Les conventions déjà générées ne changent pas.** Déposer, modifier ou supprimer une image n'affecte que les suivantes.
