...
Quatre filtres sont à votre disposition : **Domaine**, **Région**, **Dates** et **Disponibilité**.

## 3. Ouvrir l'offre qui vous intéresse

La fiche affiche le nombre de **places restantes**, la date, l'horaire et le lieu.
...
Cliquez sur **« Inscrire »**, ou sur **« Préinscrire »** si le lycée d'accueil a activé les préinscriptions.
